...
INSERT INTO "new_concert" ("created_at", "deleted", "description", "id", "seat", "updated_at", "user_id") SELECT "created_at", "deleted", "description", "id", "seat", "updated_at", "user_id" FROM "concert";
DROP TABLE "concert";
